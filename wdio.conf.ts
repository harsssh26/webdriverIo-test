...
export function getOrgSystemDate() {
        if (orgSystemDate === undefined) throw new Error("OrgSystemDate has value 'Undefined', \ncall pickSystemDate() before getOrgSystemDate()")
        return orgSystemDate
}
...
export const config: Options.Testrunner = {
        ...
        /*
        The .env file, short for "environment," stores sensitive information in a key-value format. 
        The values are accessed during runtime using environment variables. 
        This approach ensures that your sensitive data remains confidential and separate from your codebase.
        */
        reporters:
                [
                        'spec',
        ...
        //         if (!passed) {
        //                 // await browser.saveScreenshot(`./screenshots/${test.title.replace(' ', '_')}.png`)
